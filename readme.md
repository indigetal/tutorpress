<img src=".github/tutor-github.png" alt="TutorPress" width="100%"/>

## What is TutorPress LMS?

TutorPress LMS is a complete, feature-packed, and robust WordPress LMS plugin to easily create & sell courses online. All the features of this learning management system hit all the checkpoints for a full-fledged online course marketplace.
...
2. Clone the repository `git clone git@github.com:indigetal/tutorpress.git`.
...
## Looking for Contributors or a New Maintainer!

This project is currently in need of contributors, and I'm open to someone taking over its maintenance so long as they demonstrate a commitment to maintaining full support of Gutenberg and WordPress best practices.
If you're interested, please open an issue or contact me at brandon@indigetal.com.
