...
return array(
    ...
    'TutorPress_Capability_Fixes' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-capability-fixes.php',
    'TutorPress_Certificate_Controller' => $baseDir . '/includes/rest/class-certificate-controller.php',
    'TutorPress_Collaborative_Editing' => $baseDir . '/includes/shared/class-tutorpress-collaborative-editing.php',
    ...
    'TutorPress_Course_Sync_Context' => $baseDir . '/includes/tutorlms/compatibility/course/class-tutorpress-course-sync-context.php',
    'TutorPress_Course_Sync_Service' => $baseDir . '/includes/tutorlms/compatibility/course/class-tutorpress-course-sync-service.php',
    ...
    'TutorPress_H5P_Learner_Bridge' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-h5p-learner-bridge.php',
    'TutorPress_H5P_Listing_Overrides' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-h5p-listing-overrides.php',
    'TutorPress_H5P_Review_Ajax' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-h5p-review-ajax.php',
    'TutorPress_H5P_Review_Mark' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-h5p-review-mark.php',
    'TutorPress_H5P_Review_Overrides' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-h5p-review-overrides.php',
    'TutorPress_H5P_Review_Results' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-h5p-review-results.php',
    'TutorPress_H5P_Runtime_Overrides' => $baseDir . '/includes/tutorlms/overrides/class-tutorpress-h5p-runtime-overrides.php',
    'TutorPress_Lesson' => $baseDir . '/includes/post-types/class-tutorpress-lesson.php',
    'TutorPress_Lesson_Sync_Context' => $baseDir . '/includes/tutorlms/compatibility/lesson/class-tutorpress-lesson-sync-context.php',
    'TutorPress_Lesson_Sync_Service' => $baseDir . '/includes/tutorlms/compatibility/lesson/class-tutorpress-lesson-sync-service.php',
    'TutorPress_Lesson_Video_Duration' => $baseDir . '/includes/tutorlms/compatibility/lesson/class-tutorpress-lesson-video-duration.php',
