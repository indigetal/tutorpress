	...
	<div class="tutor-mb-32">
		<ul class="tutor-nav" tutor-priority-nav>
			...
			<li class="tutor-nav-item tutor-nav-more tutor-d-none">
				<a class="tutor-nav-link tutor-nav-more-item" href="#"><span class="tutor-mr-4"><?php esc_html_e( 'More', 'tutorpress-pro' ); ?></span> <span class="tutor-nav-more-icon tutor-icon-times"></span></a>
