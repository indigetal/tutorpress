            ...
            case "settings":
              return (
                <SettingsTab
                  ...
                  enableAnswerReveal={formState.settings.enable_answer_reveal}
                  answersRevealDuration={formState.settings.answers_reveal_duration}
                  hidePreviousButton={formState.settings.hide_previous_button}
